public class ForceMotionSubActivityStateMachine : ViewStateMachine<ActivityFiveSubActivityState, ForceMotionView>
{
	public ForceMotionSubActivityStateMachine(ForceMotionView view) : base(view)
	{
	}
